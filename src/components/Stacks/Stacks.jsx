  ...
  return (
    <div className="mt-40">
      ...
      <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm md:mb-12 md:grid-cols-2 bg-white  ">
        <figure className="flex flex-col items-start justify-start p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e ">
        ...
        <figure className="flex flex-col items-start justify-start p-8 text-center bg-white border-b border-gray-200 md:rounded-se-lg ">
          <figcaption className="flex items-center justify-start mb-4 lg:mb-8  text-3xl">
